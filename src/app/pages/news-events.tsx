import { Calendar, Clock, MapPin, Youtube, ExternalLink, Loader2, FileText, Download } from "lucide-react";
...
export function NewsEvents() {
  ...
  const publications: Publication[] = [
    ...
    { name: "BABYEYI P1.docx", section: "Primary 1", size: "Download" },
    { name: "BABYEYI P2.docx", section: "Primary 2", size: "Download" },
    { name: "BABYEYI P3.docx", section: "Primary 3", size: "Download" },
    { name: "BABYEYI P4.docx", section: "Primary 4", size: "Download" },
    { name: "BABYEYI P5.docx", section: "Primary 5", size: "Download" },
    { name: "BABYEYI P6.docx", section: "Primary 6", size: "Download" },
  ];
    ...
    <div>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-950 dark:to-slate-900 text-white py-12 sm:py-16 section-transition">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl mb-3 sm:mb-4 drop-shadow-lg">Announcements & Publications</h1>
          <p className="text-lg sm:text-xl text-blue-100">
            Stay connected with the latest news, events, and school publications
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Tabs defaultValue="news" className="w-full">
            ...
            <TabsContent value="news" className="space-y-12">
              ...
              {/* Upcoming Events */}
              <div className="bg-gray-50 dark:bg-slate-900 p-6 sm:p-8 rounded-xl">
            ...
            <TabsContent value="publications">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl mb-6 sm:mb-8 dark:text-white">School Publications</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                  {publications.map((pub, index) => (
                    <Card key={index} className="glass-card hover-glow flex flex-col">
                      <CardContent className="p-4 sm:p-6 flex flex-col h-full">
                        <div className="flex items-start gap-3 mb-4 flex-1">
                          <FileText className="h-6 w-6 text-blue-900 dark:text-blue-400 flex-shrink-0 mt-1" />
                          <div>
                            <h3 className="font-semibold dark:text-white text-base sm:text-lg mb-1">{pub.section}</h3>
                            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">{pub.name}</p>
                          </div>
                        </div>
                        <a
                          href={`/publications/${pub.name}`}
                          download
                          className="inline-flex items-center gap-2 text-sm font-medium text-blue-900 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-all duration-300 hover:gap-3 self-start"
                        >
