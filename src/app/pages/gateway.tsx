...
export function Gateway() {
  ...
  useEffect(() => {
    ...
    camera.position.set(0, 1, 14); // Positioned slightly up to view the running plane in perspective
    camera.lookAt(0, 0, 0);
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 font-sans selection:bg-pink-500/30">
        ...
        <div className="relative z-10 flex min-h-screen flex-col justify-between px-4 py-8 sm:px-6 lg:px-8">
          ...
          <header className="flex justify-between items-center max-w-7xl mx-auto w-full">
            ...
            <Button
              ...
              className="group py-5 px-5 rounded-full border border-pink-500/30 bg-pink-600/10 hover:bg-pink-600/20 text-pink-300 font-semibold flex items-center gap-2 hover:shadow-[0_0_20px_rgba(236,72,153,0.3)] transition-all cursor-pointer"
            >
              <Gamepad2 className="h-4 w-4 text-pink-400 group-hover:scale-125 transition-transform animate-bounce" />
      ...
      {isGameMode && (
        <div className="relative z-10 flex min-h-screen flex-col justify-between p-4 sm:p-6 lg:p-8 select-none">
          ...
          {/* Top fixed HUD */}
          <header className="w-full max-w-2xl mx-auto flex items-center justify-between px-6 py-4 rounded-3xl border border-white/10 bg-slate-950/45 backdrop-blur-xl shadow-2xl animate-in slide-in-from-top-6 duration-500">
            <div className="flex items-center gap-3">
              <img src={logoImg} alt="Jericho Logo" className="h-10 w-auto" />
              <div>
            ...
            <div className="flex items-center gap-6">
              <div className="text-center">
                ...
                <p className="text-2xl font-black text-pink-400 drop-shadow">{score}m</p>
              </div>
              ...
              {highScore > 0 && (
                <>
                  ...
                  <div className="text-center">
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Record</p>
                    <div className="flex items-center gap-1 text-amber-400">
                      <Trophy className="h-4 w-4" />
                      <p className="text-2xl font-black">{highScore}m</p>
                    </div>
                  </div>
                </>
              )}
            ...
            <Button
              ...
              className="py-2 px-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-white/80 text-xs font-semibold cursor-pointer"
            >
              Exit
            </Button>
          </header>
          ...
          <main className="flex-1 flex items-center justify-center">
            {gameState === "playing" && (
              <div className="text-center pointer-events-none select-none opacity-30 animate-pulse space-y-1">
                <p className="text-slate-400 text-sm tracking-widest uppercase font-black">
                  Press SPACEBAR, UP-ARROW, or TAP screen to Jump
                </p>
                <p className="text-pink-400 text-[10px] tracking-wider uppercase font-bold">
            ...
            {/* Game Over Screen */}
            {gameState === "gameover" && (
              <div className="w-full max-w-md p-8 rounded-3xl border border-white/20 bg-slate-950/85 backdrop-blur-2xl shadow-2xl animate-in zoom-in-95 duration-300 text-center space-y-6">
                <div className="inline-flex items-center justify-center p-4 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 animate-bounce">
                  <Gamepad2 className="h-12 w-12" />
                </div>

                <div className="space-y-2">
                  <h3 className="text-3xl font-black text-white tracking-tight">Ouch! Crash!</h3>
                ...
                <div className="p-4 rounded-2xl bg-white/5 border border-white/10 grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">Distance</p>
                    <p className="text-3xl font-black text-pink-400">{score}m</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-400 font-bold uppercase tracking-wider">High Score</p>
                    <p className="text-3xl font-black text-white">{highScore}m</p>
                  </div>
                </div>

                {score >= highScore && score > 0 && (
                  <p className="text-emerald-400 text-xs font-bold tracking-widest uppercase animate-pulse">
                    🏆 New High Score! 🏆
                  </p>
                )}
                ...
                <div className="flex flex-col gap-3">
                  <Button
                    onClick={triggerGameMode}
                    className="w-full py-6 rounded-xl font-bold bg-gradient-to-r from-pink-500 via-indigo-600 to-amber-500 hover:opacity-90 text-white shadow-lg transition-all flex items-center justify-center gap-2 cursor-pointer"
                  >
                  ...
                  <Button
                    onClick={() => navigate("/school")}
                    className="w-full py-6 rounded-xl font-bold border border-white/10 bg-white/5 hover:bg-white/10 text-white transition-all flex items-center justify-center gap-2 cursor-pointer"
                  >
