...
export function Layout() {
  ...
  const navLinks = [
    ...
    { name: "About Us", path: "/school/about" },
    { name: "News & Events", path: "/school/news-events" },
    { name: "Academics", path: "/school/academics" },
    { name: "Apply Now", path: "/school/apply" },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <button
                onClick={toggleTheme}
                className="theme-toggle p-2 rounded-full bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-yellow-300 hover:bg-gray-200 dark:hover:bg-slate-600 cursor-pointer"
              ...
              <Link
                to="/"
                className="p-2 rounded-full bg-indigo-100 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-200 dark:hover:bg-indigo-900/50 flex items-center gap-1.5 px-3 text-xs font-semibold transition-all duration-300"
                aria-label="Back to 3D Gateway"
              >
                <Sparkles className="h-4 w-4 animate-pulse text-amber-500" />
                <span className="hidden sm:inline">3D Game</span>
              </Link>
            ...
            <div className="md:hidden flex items-center gap-2">
              <Link
                to="/"
                className="p-2 rounded-full bg-indigo-100 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400"
                aria-label="Back to 3D Gateway"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li>
                  <Link to="/school" className="hover:text-white transition-colors duration-300 hover:translate-x-1 inline-block">
                    Home
                  </Link>
                </li>
                <li>
